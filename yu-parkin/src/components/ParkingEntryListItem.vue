  ...
  <div class="flex flex-col sm:flex-row sm:items-center py-4 px-6 gap-4"
    ...
    <div class="flex flex-col md:flex-row justify-between md:items-center flex-1 gap-6">
      <div class='flex flex-col gap-2'>
        <span class="text-xl font-bold mt-2">{{ parkingEntry['carpark-name'] }}</span>
      ...
      <div class="flex flex-col md:items-end gap-2">
        ...
        <div class="flex flex-row-reverse md:flex-row gap-2">
          ...
          <Button icon="pi pi-pencil" outlined label="Edit"
            :disabled="user.current && parkingEntry.userId !== user.current.$id"></Button>
